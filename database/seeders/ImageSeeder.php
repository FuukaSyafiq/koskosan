    ...
    public function run(): void
    {
        ...
        $images = [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 10500,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Kipas Angin dan WC", "Kos Umi Qosim"),
            ],
            [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Double Bed dengan WC dan Kipas Angin", "Kos Umi Qosim"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Lemari dan Kipas Angin", "Kos Umi Qosim"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Kamar Mandi dan Kipas Angin", "Kos Umi Qosim"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 9400,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Kamar Mandi dengan TV", "Kos Umi Qosim"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 11500,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen Lemari dan Dapur", "Kos Umi Qosim"),
            ],
            [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 9900,
                "room_id" => Room::getIdByNameAndKosName("Kos Sragen TV dengan Kamar Mandi", "Kos Umi Qosim"),
            ],
        ];
