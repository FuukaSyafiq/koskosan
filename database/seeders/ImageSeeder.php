    ...
    public function run(): void
    {
        ...
        $images = [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 10500,
                "room_id" => Room::getIdByRoomName("Kos Sragen Kipas Angin dan WC"),
            ],
            [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByRoomName("Kos Sragen Double Bed dengan WC dan Kipas Angin"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByRoomName("Kos Sragen Lemari dan Kipas Angin"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 2000,
                "room_id" => Room::getIdByRoomName("Kos Sragen Kamar Mandi dan Kipas Angin"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 9400,
                "room_id" => Room::getIdByRoomName("Kos Sragen Kamar Mandi dengan TV"),
            ],
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 11500,
                "room_id" => Room::getIdByRoomName("Kos Sragen Lemari dan Dapur"),
            ],
            [
            ...
            [
                ...
                "mime_type" => "image/jpeg",
                "size" => 9900,
                "room_id" => Room::getIdByRoomName("Kos Sragen TV dengan Kamar Mandi"),
            ],
        ];
