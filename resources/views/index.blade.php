...
<div class="min-h-screen flex flex-col">
    <main class="h-screen my-5 lg:justify-around justify-center w-full items-center flex bg-green-500 text-white flex-col lg:flex-row">
        <div class="w-full flex flex-col lg:flex-row items-center lg:justify-start justify-center" data-aos="fade-right">
            ...
            <div class="mr-5 text-center lg:text-left">
                ...
                <p class="my-5 text-lg sm:text-xl md:text-2xl font-bolder font-poppins break-words" data-aos="fade-right">
