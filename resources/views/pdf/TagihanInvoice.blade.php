...
<html>
    ...
    <body>
        ...
        <!-- Title -->
        <h1 class="text-center text-2xl font-bold mb-4">Tagihan</h1>
        <hr class="border-black mb-4">

        <!-- Transaction Information -->
        <div class="mb-6">
            <p class="text-lg"><strong>Kepada:</strong> {{ $user->name }}</p>
        ...
        <div class="my-6">
            <table class="w-4/5 mx-auto my-24 border border-black">
                <thead class="bg-gray-200">
                    <tr>
                        <th class="border border-black py-2 px-4 text-center">Jatuh Tempo</th>
                ...
                <tbody>
                    <tr>
                        <td class="border border-black py-2 px-4 text-center">{{ $record->due_date }}</td>
                        <td class="border border-black py-2 px-4 text-center">{{ $room->name }}</td>
