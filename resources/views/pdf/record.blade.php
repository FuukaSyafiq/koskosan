...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.curlwind.com?classes=text-center,text-2xl,font-bold,text-lg,italic,mb-4,mb-6,mt-6,p-6,mx-auto,my-24,my-auto,my-6,w-4/5,border,border-black,bg-gray-200,py-2,px-4,w-48,h-auto">
</head>
<body>
...
<div>
    <div class="my-6 mx-auto">
        <img class="w-48 h-auto mx-auto" src="{{ $image_base64 }}" alt="Invoice Image">
    </div>
</div>
@else
<div>
